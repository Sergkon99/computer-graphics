...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.le_rotate_angle = QtWidgets.QLineEdit(self.centralwidget)
        self.le_rotate_angle.setGeometry(QtCore.QRect(680, 380, 113, 20))
        self.le_rotate_angle.setObjectName("le_rotate_angle")
        self.pb_rotate = QtWidgets.QPushButton(self.centralwidget)
        self.pb_rotate.setGeometry(QtCore.QRect(624, 410, 171, 31))
        self.pb_rotate.setObjectName("pb_rotate")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(620, 380, 51, 21))
